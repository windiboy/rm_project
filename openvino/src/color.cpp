...
int main(int argc, char** argv){
    ...
    image_transport::Subscriber img_sub = it.subscribe("/usb_cam/image_raw",1,imageCallback);
    ...
    labels.push_back("pink");
    labels.push_back("violet");
    labels.push_back("orange");
    ...
    cnnNetwork = ie.ReadNetwork("/home/bcsh/workspace/src/openvino/color_model/color.xml");
                     ...
                     for (int i = 0; i < maxProposalCount; i++) {
                         ...
                         if (confidence > 0.5) {
                             ...
                             cv::putText(frame,
                                         ...
                                         cv::Scalar(0, 0, 255));
                             cv::rectangle(frame, cv::Point2f(xmin, ymin), cv::Point2f(xmax, ymax), cv::Scalar(g_rng.uniform(0, 255), g_rng.uniform(0, 255), g_rng.uniform(0, 255)));
                         }
                     }
