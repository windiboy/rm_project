...
int main(int argc, char** argv){
    ...
    labels.push_back("door-handle");
    labels.push_back("charger");
    labels.push_back("fire");
    ...
    cnnNetwork = ie.ReadNetwork("/home/zoo/catkin_ws/src/openvino/safe_model/safe.xml");
